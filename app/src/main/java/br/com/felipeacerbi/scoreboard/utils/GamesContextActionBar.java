 ...
 */
public class GamesContextActionBar implements android.support.v7.view.ActionMode.Callback {

    private MainScoreActivity activity;
    private ListView list;
    private GamesListAdapter adapter;
    private GamesFragment frag;

    public GamesContextActionBar(MainScoreActivity activity, GamesFragment frag, ListView list, int pos) {
